...
<body>
	<div style=" width:500px;margin-left:460px;margin-top:40px;margin-bottom:5px; font-size: 20px; font-weight: 600;font-size:30px;border-bottom:1px solid gray; "> 
		<span>비밀번호 재설정</span>
	</div>
